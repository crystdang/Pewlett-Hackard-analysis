...
-- CASCADE not needed as the table was not connected to any other table
...
-- Sales team req using retirement_info
-- Employee numbers
-- Employee first name
-- Employee last name
